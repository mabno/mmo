...
class Sprite extends Rectangle{
	...
	public update() : void {
		super.update();
		if(this.right - this.camera.x < 0 || this.x - this.camera.x > Config.instance.viewport.width ||
			this.bottom - this.camera.y < 0 || this.y - this.camera.y > Config.instance.viewport.height){
